...
% TODO: Adicionar Referências para os links dos sites das câmeras
...
% TODO: Adicionar referencia ao link: https://developer.nvidia.com/embedded/learn/success-stories/stereolabs
% TODO: Atividades futuras

% 1 - Falar sobre SLAM e ROS
% 2 - Falar que talvez o problema de processamento possa ser resolvido se utilizamos uma camera stereo que ja realize disponibilize o mapa de disparidades e a plataforma fique sómente pra realizar um pós processamento do mapa obtido.
% 3 - Falar sobre implementar as diretivas de GPU para um método que apresente maior confiança (pesquisar algo do tipo "SGBMGPU")
...
% 4 - Explicar pq da pequena diferenca de desempenho do Metodo BM e o Metodo BM_GPU na Jetson TK1
% 5- Realizar ensaio de Ground Truth para validação da Distância Detectada
% 6 - Desenvolvimento de Algoritmos que melhorem a confiança do métodos estéreo, por exemplo implementação do metodo SGM em CUDA como mostrado no link:
