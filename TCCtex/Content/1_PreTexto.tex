...
%------------------------------------- RESUMO - PORTUGUÊS -------------------------------------------
%TODO: O Resumo deve estar completo, ou seja, com todas as partes do trabalho, resumidamente. Aqui vc apresentou somente a introdução. Deve conter a proposta do trabalho (quais algoritmos utilizados para a abordagem, quais ferramentas, etc...), os resultados e a conclusão principal....tudo resumidamente...
