...
\> BM 	 \> Block Matching 					 													\\
\> CUDA 	 \> Compute Unified Device Architecture - Plataforma de computação paralela				\\
...
\> MAVS 	 \> Micro Air Vehicle - Micro Veículo Aéreo												\\
...
\> SGBM 	 \> \textit{Semi-Global Block Matching}													\\
