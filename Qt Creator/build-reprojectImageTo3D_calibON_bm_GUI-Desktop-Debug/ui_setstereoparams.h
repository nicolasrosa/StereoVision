...
public:
    ...
    void setupUi(QDialog *SetStereoParams)
    {
        ...
        preFilterSize_slider->setMaximum(100);
        ...
        preFilterSize_spinBox->setGeometry(QRect(380, 10, 51, 27));
        preFilterSize_spinBox->setMaximum(100);
        ...
        preFilterCap_slider->setMaximum(100);
        ...
        preFilterCap_spinBox->setGeometry(QRect(380, 50, 51, 27));
        preFilterCap_spinBox->setMaximum(100);
        ...
        SADWindowSize_slider->setMaximum(100);
        ...
        SADWindowSize_spinBox->setGeometry(QRect(380, 90, 51, 27));
        SADWindowSize_spinBox->setMaximum(100);
        ...
        minDisparity_spinBox->setGeometry(QRect(380, 130, 51, 27));
        ...
        numberOfDisparities_slider->setMaximum(100);
        ...
        numberOfDisparities_spinBox->setGeometry(QRect(380, 170, 51, 27));
        numberOfDisparities_spinBox->setMaximum(100);
        ...
        textureThreshold_slider->setMaximum(100);
        ...
        textureThreshold_spinBox->setGeometry(QRect(380, 210, 51, 27));
        textureThreshold_spinBox->setMaximum(100);
        ...
        uniquenessRatio_spinBox->setGeometry(QRect(380, 250, 51, 27));
        uniquenessRatio_spinBox->setMaximum(100);
        ...
        speckleWindowSize_spinBox->setGeometry(QRect(380, 290, 51, 27));
        ...
        speckleRange_spinBox->setGeometry(QRect(380, 330, 51, 27));
        ...
        disp12MaxDiff_spinBox->setGeometry(QRect(380, 370, 51, 27));
