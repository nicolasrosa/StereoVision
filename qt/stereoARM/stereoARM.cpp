...
void StereoProcessor::createBM(){
    bm.init(0,ndisparities,SADWindowSize);
...
#ifdef TARGET_PC
    /* Run at PC */
    capL.open("/home/ubuntu/nicolas/workspace/data/20004.avi");
    capR.open("/home/ubuntu/nicolas/workspace/data/30004.avi");
#endif
...
void StereoProcessor::calculateDisparities(){
    ...
    bm.operator ()(imageL_grey,imageR_grey,disp_16S,CV_16S);
#endif
...
*/
    ...
    bm.state.obj->preFilterSize = 127;
    bm.state.obj->preFilterCap = 36;
    bm.state.obj->SADWindowSize = 81;
    bm.state.obj->minDisparity = 7;
    bm.state.obj->numberOfDisparities = 16;
    bm.state.obj->textureThreshold = 0;
    bm.state.obj->uniquenessRatio = 0;
    bm.state.obj->speckleWindowSize = 0;
    bm.state.obj->speckleRange = 0;
    bm.state.obj->disp12MaxDiff = 1;
